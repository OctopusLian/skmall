...
func (f *FrontUser) FrontUserRegister(ctx context.Context, in *user_srv.FrontUserRequest, out *user_srv.FrontUserResponse) error {
	// 用户注册
	//data_source.Db
	email := in.Email
	captche := in.Code
...
func (f *FrontUser) FrontUserSendEmail(ctx context.Context, in *user_srv.FrontUserMailRequest, out *user_srv.FrontUserResponse) error {
	// 发送邮件
	email := in.Email
...
func (f *FrontUser) FrontUserLogin(ctx context.Context, in *user_srv.FrontUserRequest, out *user_srv.FrontUserResponse) error {
